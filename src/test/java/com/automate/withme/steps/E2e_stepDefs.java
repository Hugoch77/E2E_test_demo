...
public class E2e_stepDefs extends testngUtils {
	...
	public void user_gives_the_password_as(String pass) throws InvalidKeyException, IllegalBlockSizeException,
	...
	public void user_selects_the_items_and_add_them_to_cart(DataTable dataTable) {
		...
		qty = new int[] { Integer.parseInt(data.get("Apple")), Integer.parseInt(data.get("Banana")),
				Integer.parseInt(data.get("Orange")), Integer.parseInt(data.get("Bringal")),
